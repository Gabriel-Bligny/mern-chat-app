...
const GroupChatModal = ({ children }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const { data } = await axios.post("https://mern-chat-app-backend-22ov.onrender.com/api/chat/group", { name: groupChatName, users: JSON.stringify(selectedUsers.map(u => u._id)) }, config)
